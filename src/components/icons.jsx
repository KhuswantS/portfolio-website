...
export function TwitterIcon(props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M18.24 2.75h3.05l-6.67 7.62 7.85 10.38h-6.14l-4.81-6.3-5.5 6.3H2.98l7.14-8.16L2.6 2.75h6.3l4.35 5.75 4.99-5.75Zm-1.07 16.2h1.7L7.9 4.47H6.07l11.1 14.48Z" />
    </svg>
  );
}
