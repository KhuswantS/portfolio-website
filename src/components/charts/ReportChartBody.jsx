...
// The actual Recharts render - lazy-loaded by ReportChart.jsx so Recharts
...
function ChartTooltip({ active, payload, label }) {
  ...
  return (
    <div className="rounded-md border border-navy/10 bg-paper-dim px-3 py-2 shadow-md">
...
export default function ReportChartBody({ chartType, data, dataKey, labelKey }) {
  return (
